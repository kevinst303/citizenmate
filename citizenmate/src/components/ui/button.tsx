...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-full border border-transparent bg-clip-padding text-[0.9375rem] font-semibold whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:scale-[0.98] disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default: "bg-cm-teal text-white shadow-md shadow-black/10 hover:bg-cm-teal-dark hover:brightness-110 hover:shadow-lg hover:shadow-cm-teal/30",
        dark: "bg-cm-dark text-white hover:bg-cm-dark-light hover:shadow-lg hover:shadow-black/15",
        outline:
          "border-[1.5px] border-border bg-transparent text-cm-dark hover:border-cm-teal hover:text-cm-teal hover:bg-cm-teal-light",
        secondary:
      ...
      size: {
        default:
          "h-11 gap-2 px-6 py-2 has-data-[icon=inline-end]:pr-4 has-data-[icon=inline-start]:pl-4",
        ...
        sm: "h-9 gap-1.5 rounded-full px-4 text-sm in-data-[slot=button-group]:rounded-lg has-data-[icon=inline-end]:pr-3 has-data-[icon=inline-start]:pl-3 [&_svg:not([class*='size-'])]:size-3.5",
        lg: "h-14 gap-2 px-8 py-3.5 text-base has-data-[icon=inline-end]:pr-6 has-data-[icon=inline-start]:pl-6",
        icon: "size-11",
        "icon-xs":
