      ...
      <div className="flex-1 px-4 py-3 space-y-1.5">
        {upcomingHolidays.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full py-8 text-center">
            <CalendarDays className="w-10 h-10 text-cm-slate-200 mb-3" />
            <p className="text-sm font-semibold text-cm-slate-700">No upcoming holidays</p>
            <p className="text-xs text-cm-slate-500 mt-1 max-w-[200px]">We couldn't find any upcoming public holidays for this year.</p>
          </div>
        ) : (
          <>
