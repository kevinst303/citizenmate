...
Plans:
- [x] 03-A-PLAN.md — Navbar + Layout Shell + User Menu (NAV-01, NAV-02, NAV-03, NAV-04)
- [x] 03-B-PLAN.md — Hero + CTA sections + Footer (HERO-01–03, CTA-01–02, FOOT-01–02)
- [x] 03-C-PLAN.md — Features + How It Works + Social Proof (FEAT-01–02, HIOW-01–02, SOCP-01–03)
- [x] 03-D-PLAN.md — Pricing + FAQ + Shared Modals (PRIC-01–02, FAQ-01, MODL-01)
- [x] 03-E-PLAN.md — Quiz components (QUIZ-01–03)
- [x] 03-F-PLAN.md — Study components (STUD-01–03)
- [x] 03-G-PLAN.md — Dashboard components (DASH-01–03)
